    ...
    <div className="space-y-20">
      <section className="text-center space-y-8 mb-16 pt-8">
        <div className="space-y-4">
          <h2 className="text-5xl lg:text-6xl font-bold font-display text-academy-dark leading-tight">
            Impara l'Inglese come un Professionista
          </h2>
        ...
        <div className="flex gap-4 justify-center flex-wrap pt-6">
          <button
            ...
            className="px-8 py-4 bg-academy-blue text-white font-semibold rounded-lg hover:bg-academy-light-blue transition-colors text-lg shadow-lg"
          >
            🎓 Inizia i Corsi
          </button>
          <button
