    ...
    <div className="space-y-20">
      <section className="text-center space-y-8 mb-16 pt-8">
        <div className="space-y-4">
          <h2 className="text-lg sm:text-4xl lg:text-6xl font-bold font-display text-academy-dark leading-tight">
            Inglese <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-blue-600">Tecnico</span>
            <br /> per Professionisti <br className="hidden sm:block" />
            del Mare
          </h2>
