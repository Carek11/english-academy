...
export default function PremiumPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-100 to-sky-50">
      <div className="space-y-16 max-w-7xl mx-auto py-16 px-4 flex flex-col items-end">
        <div className="max-w-2xl w-full">
          <section className="text-right space-y-12 pb-8">
            ...
            <p className="text-xl text-academy-gray leading-relaxed">
          ...
          {isPremium ? (
            ...
            <div className="space-y-16">
              ...
              <div className="bg-gradient-to-br from-sky-400 via-sky-500 to-blue-600 rounded-2xl p-12 text-white text-center shadow-xl">
                ...
                <p className="text-base font-bold opacity-100 mb-8 bg-white bg-opacity-20 px-6 py-3 rounded-lg">
