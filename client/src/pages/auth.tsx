    ...
    <div className="min-h-[60vh] flex items-center justify-center py-12">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        <div className="bg-gradient-to-r from-academy-blue to-academy-dark p-8 text-white text-center">
          ...
          <p className="text-sm opacity-80 mt-1">Accedi per salvare i tuoi progressi</p>
        </div>
          ...
          {!REGISTRATION_BLOCKED && (
            <div className="space-y-6 text-center">
              <p className="text-academy-gray text-sm leading-relaxed">
                Accedi con Google per salvare i progressi nei quiz, tracciare i tuoi risultati e accedere a tutti i contenuti.
              </p>
              <a
                href="/auth/google"
                data-testid="button-google-login"
                className="flex items-center justify-center gap-3 w-full py-4 bg-white border-2 border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 hover:shadow-md transition-all text-base font-semibold text-gray-700 shadow-sm"
              >
              ...
              <p className="text-xs text-academy-gray leading-relaxed">
                Non hai un account?{" "}
                <span className="font-semibold text-academy-blue">Si crea automaticamente con Google</span> al primo accesso.
              </p>
            </div>
          )}
