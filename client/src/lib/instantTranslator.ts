...
const commonWords: Record<string, string> = {
  ...
  "give": "dare", "gives": "dà", "put": "mettere", "say": "dire", "says": "dice", "see": "vedere", "see": "vedi",
  ...
  "use": "usa", "work": "funziona", "call": "chiama", "ask": "chiede", "need": "ha bisogno",
  "feel": "sente", "become": "diventa", "leave": "lascia", "put": "mette", "mean": "significa",
  ...
  "draw": "disegna", "break": "rompe", "spend": "spende", "eat": "mangia", "cover": "copre",
  "catch": "cattura", "draw": "tira", "break": "rompe", "spend": "spende", "lead": "guida",
  ...
  "fact": "fatto", "hand": "mano", "point": "punto", "government": "governo", "company": "azienda",
  "number": "numero", "group": "gruppo", "problem": "problema", "fact": "fatto", "result": "risultato",
  ...
  "car": "auto", "road": "strada", "king": "re", "queen": "regina", "president": "presidente",
  ...
  "clean": "pulito", "dirty": "sporco", "bright": "luminoso", "dark": "scuro", "beautiful": "bellissimo",
  ...
  "dull": "opaco", "smooth": "liscio", "rough": "ruvido", "heavy": "pesante", "light": "leggero",
